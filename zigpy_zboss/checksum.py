...
class CRC8:
    ...
    Description:
    width=8 poly=0x4d init=0xff refin=true refout=true xorout=0xff
    check=0xd8 name="CRC-8/KOOP"
    """
...
class CRC16:
    ...
    Description:
    width=16 poly=0x1021 init=0xff refin=false refout=false xorout=0x0000
    check=0x29b1 name="CRC-16/CITT"
    """
    ...
    def __init__(self, initial_string=b'', initial_start=0x0000):
        """Create a new crc16 hash instance."""
        self._sum = initial_start
        self._update(initial_string)
    ...
    def hexdigest(self):
        ...
        exchange the value safely in email or other non-binary environments.
        """
        return hex(self._sum)[2:].zfill(4)
    ...
    def _update(self, bytes_):
        ...
        _sum = self._sum
        for byte in bytes_:
            _sum = (_sum >> 8) ^ table[(_sum ^ byte) & 0x00FF]
        self._sum = _sum
